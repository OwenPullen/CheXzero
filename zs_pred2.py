...
#     ToTensor()
# ])
from monai.transforms import Compose, Rotated, Flip, ToTensor, RandAffine
...
from tta_fns2 import ensemble_models_tta

# transforms = Rotated(keys = 'image', angle=30 * 3.1415 / 180)
#transforms = Flip(spatial_axis = 0)
